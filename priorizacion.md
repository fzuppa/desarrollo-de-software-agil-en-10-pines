...
Con el objetivo de lograr esto, elegimos un conjunto deuser storiesque nos permitan construir el esqueleto de la aplicación, los componentes que representan la arquitectura de la misma. En esta etapa, ponemos énfasis en la parte iterativa del proceso de desarrollo. Nos enfocamos en que se vea algo que funcione y dejamos los incrementos para más adelante. Esta heurística es lo que Andy Hunt y Dave Thomas llaman un[tracer bullet](http://www.artima.com/intv/tracer.html).
